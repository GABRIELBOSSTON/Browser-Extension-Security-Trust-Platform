use std::sync::Arc;
use crate::domain::persistence::{ScanRepository, AuditLogRepository, ScanRecord, AuditLogEntry, AuditAction, AuditMetadata};
...
impl PersistenceService {
    pub fn new(scan_repo: Arc<dyn ScanRepository>, audit_repo: Arc<dyn AuditLogRepository>) -> Self {
        Self { scan_repo, audit_repo }
    }
